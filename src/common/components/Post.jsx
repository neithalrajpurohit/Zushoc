...
import { postTweet, getFeed } from "../../features/posts/postSlice";
  ...
  const uploadHandler = async () => {
    ...
    try {
      const response = await axios.post(
        "https://api.cloudinary.com/v1_1/dlfkr6n8m/image/upload",
        data
      );
  ...
  return (
    <div style={{ marginTop: "7rem" }}>
      ...
      <div className="btn-component">
        <input
          className="center file-component"
          type="file"
        ...
        <button className="center post-component" onClick={() => postOnClick()}>
          Post
        </button>
        <button
          className="center add-component"
